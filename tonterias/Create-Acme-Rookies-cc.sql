...
INSERT INTO `audit` VALUES (287,0,'\0','2019-08-01 00:00:00',5,'Recuperación datos',270),(288,0,'\0','2019-08-01 00:00:00',5,'TEST',270),(291,0,'\0','2019-08-01 00:00:00',5,'TEST',271);
/*!40000 ALTER TABLE `audit` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `audit_netcashes`
--

DROP TABLE IF EXISTS `audit_netcashes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `audit_netcashes` (
  `audit` int(11) NOT NULL,
  `netcashes` int(11) NOT NULL,
  UNIQUE KEY `UK_tmlnwn2dckfr8jqrfmeanc796` (`netcashes`),
  KEY `FK_j0j69qajuo2tey8xe6yx4q1a` (`audit`),
  CONSTRAINT `FK_j0j69qajuo2tey8xe6yx4q1a` FOREIGN KEY (`audit`) REFERENCES `audit` (`id`),
  CONSTRAINT `FK_tmlnwn2dckfr8jqrfmeanc796` FOREIGN KEY (`netcashes`) REFERENCES `netcashe` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `audit_netcashes`
--

LOCK TABLES `audit_netcashes` WRITE;
/*!40000 ALTER TABLE `audit_netcashes` DISABLE KEYS */;
INSERT INTO `audit_netcashes` VALUES (288,289),(288,290),(291,292),(291,293);
/*!40000 ALTER TABLE `audit_netcashes` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `company_netcashes`
--

DROP TABLE IF EXISTS `company_netcashes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `company_netcashes` (
  `company` int(11) NOT NULL,
  `netcashes` int(11) NOT NULL,
  UNIQUE KEY `UK_490g3y9stky4s1sty13f46qok` (`netcashes`),
  KEY `FK_5rgrstmikj5webh1vkvg8xjcd` (`company`),
  CONSTRAINT `FK_5rgrstmikj5webh1vkvg8xjcd` FOREIGN KEY (`company`) REFERENCES `company` (`id`),
  CONSTRAINT `FK_490g3y9stky4s1sty13f46qok` FOREIGN KEY (`netcashes`) REFERENCES `netcashe` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `company_netcashes`
--

LOCK TABLES `company_netcashes` WRITE;
/*!40000 ALTER TABLE `company_netcashes` DISABLE KEYS */;
INSERT INTO `company_netcashes` VALUES (278,289),(278,290),(280,292),(280,293);
/*!40000 ALTER TABLE `company_netcashes` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `netcashe`
--

DROP TABLE IF EXISTS `netcashe`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `netcashe` (
  `id` int(11) NOT NULL,
  `version` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_f3mj7ajtc7jaafyy35enp0tyo` (`track_id`),
  KEY `FK_gitkcneya9kckcwskkuhgu7gq` (`audit`),
  CONSTRAINT `FK_gitkcneya9kckcwskkuhgu7gq` FOREIGN KEY (`audit`) REFERENCES `audit` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `netcashe`
--

LOCK TABLES `netcashe` WRITE;
/*!40000 ALTER TABLE `netcashe` DISABLE KEYS */;
INSERT INTO `netcashe` VALUES (289,0,'TEST','\0','http://www.photo.com','TROME','190913/01/AB',288),(290,0,'TEST','\0','http://www.photo.com','GORK','190913/01/AC',288),(292,0,'TEST','\0','http://www.photo.com','STIM','190913/01/AD',291),(293,0,'TEST','\0','http://www.photo.com','ZURK','190913/01/AE',291);
/*!40000 ALTER TABLE `netcashe` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-09-13 10:43:36
