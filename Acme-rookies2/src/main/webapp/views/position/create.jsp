...
<security:authorize access="hasRole('COMPANY')">
	<div>
		<form:form action="position/company/edit.do" method="POST"
			id="formCreate" name="formCreate" modelAttribute="position">
			...
			<spring:message code="position.cancel" var="cancelHeader"></spring:message>
